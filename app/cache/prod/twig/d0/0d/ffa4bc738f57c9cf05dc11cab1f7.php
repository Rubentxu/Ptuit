...
class __TwigTemplate_d00dffa4bc738f57c9cf05dc11cab1f7 extends Twig_Template
{
...
";
    ...
    public function block_generic_label($context, array $blocks = array())
    {
        ...
        if ($this->getContext($context, 'required')) {
            // line 199
            echo "        ";
            $context['attr'] = twig_array_merge($this->getContext($context, 'attr'), array("class" => ((($this->getAttribute($this->getContext($context, 'attr'), "class", array(), "any", true)) ? (twig_default_filter($this->getAttribute($this->getContext($context, 'attr'), "class", array(), "any", false), "")) : ("")) . " required")));
            // line 200
            echo "    ";
        }
        // line 201
